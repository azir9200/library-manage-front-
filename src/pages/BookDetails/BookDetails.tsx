...
const BookDetails = () => {
  ...
  return (
    <div className="max-w-7xl rounded-2xl overflow-hidden shadow-lg bg-white p-5 transition-transform transform hover:scale-105 hover:shadow-xl">
      ...
      {/* Book Info */}
      <div className="py-4">
        <h3 className="text-xl font-semibold text-gray-800">📖 {singleBook.title}</h3>
        ...
        <p className="text-gray-600">
          <span className="font-semibold">Published:</span> {singleBook.publishedYear}
        </p>
        <p className="text-gray-600">
        ...
        <p className="text-gray-600">
          <span className="font-semibold">Total Copies:</span> {singleBook.copies}
        </p>
      </div>
